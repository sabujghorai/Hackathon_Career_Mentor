...
<head>
    ...
    <title>Teacher Dashboard | Career Mentor</title>
    <style>
        ...
        .role-badge { background: #e8f5e9; color: #2e7d32; padding: 4px 12px; border-radius: 20px; font-size: 14px; font-weight: bold; text-transform: uppercase; }
    </style>
</head>
<body>

    <div class="navbar">
        <h2>Career Mentor AI - Teacher Portal</h2>
    ...
    <div class="container">
        <div class="card">
            <h1>Welcome, Prof. <?= htmlspecialchars($_SESSION['fullname']); ?>! 👨‍🏫</h1>
            <p><strong>Role:</strong> <span class="role-badge"><?= htmlspecialchars($_SESSION['role']); ?></span></p>
            <p><strong>Email:</strong> <?= htmlspecialchars($_SESSION['email']); ?></p>
            <hr>
            <h3>Teacher Control Panel</h3>
            <p>Yahan se aap apne students ki progress aur mentorship guidance monitor kar sakte hain.</p>
        </div>
    </div>
